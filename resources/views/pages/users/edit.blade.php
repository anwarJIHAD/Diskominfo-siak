                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="jenis_kelamin" value="1" class="selectgroup-input"
                                            @if ($user->jenis_kelamin == '1') checked @endif>
                                        <span class="selectgroup-button">Laki-Laki</span>
                                    </label>
                                    {{-- <label class="selectgroup-item">
                                        <input type="radio" name="jenis_kelamin" value="doctor" class="selectgroup-input"
                                            @if ($user->jenis_kelamin == 'doctor') checked @endif>
                                        <span class="selectgroup-button">Doctor</span>
                                    </label> --}}
                                    <label class="selectgroup-item">
                                        <input type="radio" name="jenis_kelamin" value="0" class="selectgroup-input"
                                            @if ($user->jenis_kelamin == '0') checked @endif>
